...
[digitalcurrensy.com](https://www.digitalcurrensy.com) is what artists, labels, and managers use: global distribution, streaming, playlists, GPTs, royalties, and campaigns.
...
| | |
| --- | --- |
| [dci-website](https://github.com/DigitalCurrensy/dci-website) | Public site for the music platform. |

**Studio**

| | |
| --- | --- |
| Label IQ | AI studio at [app.labeliq.ai](https://app.labeliq.ai) |
...
TypeScript · JavaScript · React · Next.js · Python · Node.js · Vite · WebGL · Vercel
